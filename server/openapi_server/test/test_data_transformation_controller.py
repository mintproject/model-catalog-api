...
class TestDataTransformationController(BaseTestCase):
    ...
    def test_custom_datasetspecifications_id_datatransformations_get(self):
        ...
        """
        query_string = [('custom_query_name', 'custom_datatransformations'),
                        ('username', 'username_example')]
        headers = { 
            'Accept': 'application/json',
        }
        response = self.client.open(
            '/v1.8.0/custom/datasetspecifications/{id}/datatransformations'.format(id='id_example'),
            method='GET',
            headers=headers,
    ...
    def test_datatransformations_id_delete(self):
        ...
        response = self.client.open(
            '/v1.8.0/datatransformations/{id}'.format(id='id_example'),
            method='DELETE',
            headers=headers,
            query_string=query_string)
        self.assert200(response,
