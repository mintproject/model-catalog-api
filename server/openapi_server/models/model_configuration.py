...
class ModelConfiguration(Model):
    ...
    def __init__(self, type=None, label=None, inputs=None, outputs=None, description=None, cag=None, process=None, interval_time=None, implementation_script_location=None, container=None, constrain_t=None, parameters=None, component_location=None):  # noqa: E501
