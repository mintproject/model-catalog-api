...
def get_resource_not_custom(query_type, request_args, **kwargs):
    if "id" in kwargs:
        return get_one_resource(request_args=request_args, query_type=query_type, **kwargs)
...
def get_all_resource(request_args, query_type="get_all_user", **kwargs):
    """
...
def request_all(kls, owl_class_name, request_args, resource_type_uri, query_type):
    try:
        response = query_manager.obtain_query(query_directory=owl_class_name,
                                              owl_class_uri=resource_type_uri,
                                              query_type=query_type,
