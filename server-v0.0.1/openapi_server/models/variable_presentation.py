...
class VariablePresentation(Model):
    ...
    def __init__(self, uri=None, type=None, label=None, description=None, long_name=None, short_name=None, standard_name=None, relevance_level=None, unit=None):  # noqa: E501
        """VariablePresentation - a model defined in OpenAPI

        :param uri: The uri of this VariablePresentation.  # noqa: E501
        :type uri: str
    ...
    @property
    def uri(self):
        """Gets the uri of this VariablePresentation.


        :return: The uri of this VariablePresentation.
        :rtype: str
        """
        return self._uri
    ...
    @uri.setter
    def uri(self, uri):
        """Sets the uri of this VariablePresentation.


        :param uri: The uri of this VariablePresentation.
        :type uri: str
        """
        if uri is None:
