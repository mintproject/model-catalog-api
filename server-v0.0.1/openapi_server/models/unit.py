...
class Unit(Model):
    ...
    def __init__(self, uri=None, type=None, description=None, label=None, part=None, dimension=None, abbreviation=None):  # noqa: E501
        """Unit - a model defined in OpenAPI

        :param uri: The uri of this Unit.  # noqa: E501
        :type uri: str
    ...
    @property
    def uri(self):
        """Gets the uri of this Unit.


        :return: The uri of this Unit.
        :rtype: str
        """
        return self._uri
    ...
    @uri.setter
    def uri(self, uri):
        """Sets the uri of this Unit.


        :param uri: The uri of this Unit.
        :type uri: str
        """
