...
class Software(Model):
    ...
    def __init__(self, has_documentation=None, keywords=None, software_requirements=None, has_version=None, has_typical_data_source=None, has_download_url=None, reference_publication=None, description=None, screenshot=None, type=None, has_installation_instructions=None, date_created=None, contributor=None, has_faq=None, logo=None, has_contact_person=None, has_purpose=None, id=None, has_sample_visualization=None, identifier=None, memory_requirements=None, website=None, citation=None, author=None, processor_requirements=None, short_description=None, label=None, has_assumption=None, date_published=None, license=None, operating_systems=None, has_source_code=None, publisher=None, funding_source=None):  # noqa: E501
    ...
    def funding_source(self):
        """Gets the funding_source of this Software.


        :return: The funding_source of this Software.
    ...
    def funding_source(self, funding_source):
        ...
        :param funding_source: The funding_source of this Software.
        :type funding_source: List[Organization]
        """
